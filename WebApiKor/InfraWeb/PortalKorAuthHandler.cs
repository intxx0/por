...
{
    public class PortalKorAuthHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(tokens))
                {
                    ...
                    var membershipCtx = membershipService.ValidateUser(tokensValues[0], tokensValues[1], Convert.ToInt32(tokensValues[2]));
