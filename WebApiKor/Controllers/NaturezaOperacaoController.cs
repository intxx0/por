...
namespace WebApiKor.Controllers
{
    ...
    public class NaturezaOperacaoController : ApiController
    {
        ...
        public HttpResponseMessage GetNaturezaOperacao(HttpRequestMessage request)
        {
            ...
            List<NaturezaOperacaoViewModel> naturezaOp = Mapper.Map<List<natureza_operacao>, List<NaturezaOperacaoViewModel>>(naturezaoperacoes);
            ...
            response = request.CreateResponse(HttpStatusCode.OK, naturezaOp);
