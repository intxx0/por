(function (app) {
    ...
    imagensCtrl.$inject = ['$scope', 'apiService','notificationService', '$rootScope', '$translate'];

    function imagensCtrl($scope, apiService, notificationService, $rootScope, $translate) {
        ...
        function doSearch(modelOp) {
            ...
            if (validaFiltro(modelOp)) {
                ...
                $rootScope.FiltroOperacaoImg = JSON.stringify(modelOp);
                $scope.info = newItem;

                apiService.get('/api/imagens/listarimagensfiltro?filtro=' + $rootScope.FiltroOperacaoImg, null,
                    (result) => {
                        ...
                        if (result.data != "") {
                            ...
                            $scope.imagens = [];
                            notificationService.displayWarning('Não há imagens para esse filtro!');
                        }
                    },
                    (result) => {
