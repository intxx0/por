var blue = "#348fe2", blueLight = "#5da5e8", blueDark = "#1993E4", aqua = "#49b6d6", aquaLight = "#6dc5de", aquaDark = "#3a92ab", green = "#00acac", greenLight = "#33bdbd", greenDark = "#008a8a", orange = "#f59c1a", orangeLight = "#f7b048", orangeDark = "#c47d15", dark = "#2d353c", grey = "#b6c2c9", purple = "#727cb6", purpleLight = "#8e96c5", purpleDark = "#5b6392", red = "#ff5b57",
    ...
    handleLineChart = function () {
        ...
        nv.addGraph(function () {
            for (var e = [], a = [], r = 0; 100 > r; r++) e.push({ x: r, y: Math.sin(r / 10) }), a.push({ x: r, y: .5 * Math.cos(r / 10) });

            var t = [{ values: e, key: "Sine Wave", color: green },
                     { values: a, key: "Cosine Wave", color: blue }],

            n = nv.models.lineChart()
                .options({ transitionDuration: 300, useInteractiveGuideline: !0 });
    ...
    handleBarChart = function () {
        ...
        var e = [{
            ...
            values: [{ label: "A", value: 29, color: red },
        ...
        nv.addGraph(function () {
            ...
            return a.yAxis.axisLabel("Total Sales"),
                   ...
                   d3.select("#nv-bar-chart").append("svg").datum(e).call(a), nv.utils.windowResize(a.update), a
        })
    },
    ...
    handlePieAndDonutChart = function () {
        "use strict";
        var e = [{ label: "One", value: 29, color: red },
    ...
    handleStackedBarChart = function () {
        "use strict";
        var e = [{ key: "Stream 1", color: red, values: [{ x: 1, y: 10 }, { x: 2, y: 15 }, { x: 3, y: 16 }, { x: 4, y: 20 }, { x: 5, y: 57 }, { x: 6, y: 42 }, { x: 7, y: 12 }, { x: 8, y: 65 }, { x: 9, y: 34 }, { x: 10, y: 52 }, { x: 11, y: 23 }, { x: 12, y: 12 }, { x: 13, y: 22 }, { x: 14, y: 22 }, { x: 15, y: 48 }, { x: 16, y: 54 }, { x: 17, y: 32 }, { x: 18, y: 13 }, { x: 19, y: 21 }, { x: 20, y: 12 }] },
                { key: "Stream 2", color: orange, values: [{ x: 1, y: 10 }, { x: 2, y: 15 }, { x: 3, y: 16 }, { x: 4, y: 45 }, { x: 5, y: 67 }, { x: 6, y: 34 }, { x: 7, y: 43 }, { x: 8, y: 65 }, { x: 9, y: 32 }, { x: 10, y: 12 }, { x: 11, y: 43 }, { x: 12, y: 45 }, { x: 13, y: 32 }, { x: 14, y: 32 }, { x: 15, y: 38 }, { x: 16, y: 64 }, { x: 17, y: 42 }, { x: 18, y: 23 }, { x: 19, y: 31 }, { x: 20, y: 22 }] },
                { key: "Stream 2", color: dark, values: [{ x: 1, y: 20 }, { x: 2, y: 25 }, { x: 3, y: 26 }, { x: 4, y: 30 }, { x: 5, y: 57 }, { x: 6, y: 52 }, { x: 7, y: 22 }, { x: 8, y: 75 }, { x: 9, y: 44 }, { x: 10, y: 62 }, { x: 11, y: 35 }, { x: 12, y: 15 }, { x: 13, y: 25 }, { x: 14, y: 25 }, { x: 15, y: 45 }, { x: 16, y: 55 }, { x: 17, y: 35 }, { x: 18, y: 15 }, { x: 19, y: 25 }, { x: 20, y: 15 }] }];


        nv.addGraph({ generate: function () { var a = nv.models.multiBarChart().stacked(!0).showControls(!1), r = d3.select("#nv-stacked-bar-chart").append("svg").datum(e); return r.transition().duration(0).call(a), a } })
    }, ChartNvd3 = function () {
        "use strict";
        return {
            init: function () {
