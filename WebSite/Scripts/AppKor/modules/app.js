    ...
    angular.module('AppKor', ['ngRoute', 'ui.bootstrap', 'ngMap', 'base64', 'ngRoute', 'ngCookies', 'ui.mask', 'nvd3', 'ngMd5', 'ngMessages', 'ngTagsInput', 'angular.morris', 'ngLocale', 'flow', 'pascalprecht.translate', 'chart.js', 'googlechart'])
        .config(function ($routeProvider) {
            $routeProvider
                ...
                .when('/fiscalizacao', {
                    templateUrl: 'scripts/AppKor/fiscalizacao/fiscalizacao.html',
                    controller: 'fiscalizacaoCtrl'
                })
                .when('/operacoes', {
                    templateUrl: 'scripts/AppKor/fiscalizacao/operacao.html',
                    controller: 'operacaoCtrl'
                })
                .when('/indicadores', {
                    templateUrl: 'scripts/AppKor/fiscalizacao/indicadores.html',
                    controller: 'indicadoresCtrl'
                })
                .when('/listaeventos', {
                    templateUrl: 'scripts/AppKor/fiscalizacao/listaeventos.html',
                    controller: 'listaeventosCtrl'
                })
                .when('/cadastros', {
                    templateUrl: 'scripts/AppKor/cadastros/cadastros.html',
                    controller: 'cadastrosCtrl'
                })
                .when('/cadcontaemail', {
                    templateUrl: 'scripts/AppKor/cadcontaemail/cadcontaemail.html',
                    controller: 'cadcontaemailCtrl'
                })
                .when('/', {
                    templateUrl: 'scripts/AppKor/home/home.html',
                    controller: 'homeCtrl'
