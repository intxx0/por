(function (app) {
    ...
    app.controller('localizacaoOperacaoCtrl', localizacaoOperacaoCtrl);
    localizacaoOperacaoCtrl.$inject = ['$scope', '$modalInstance', 'items', 'apiService', 'notificationService', '$translate', 'NgMap', '$timeout'];

    function localizacaoOperacaoCtrl($scope, $uibModalInstance, items, apiService, notificationService, $translate, NgMap, $timeout) {
