    ...
    public class DomainToViewModelMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<evento, EventoViewModel>()
                .ForMember(vm => vm.EventoId, map => map.MapFrom(m => m.evento_id))
                .ForMember(vm => vm.TipoEvento, map => map.MapFrom(m => m.tipo_evento.desc_tipo_evento))
                .ForMember(vm => vm.NomeUsuario, map => map.MapFrom(m => m.usuario.nome))
                .ForMember(vm => vm.DataCriado, map => map.MapFrom(e => e.datacriado))
                .ForMember(vm => vm.Coordenada, map => map.MapFrom(e => e.coordenada))
                .ForMember(vm => vm.NomeUsuarioVisualizado, map => map.MapFrom(m => m.usuario1.nome))
                .ForMember(vm => vm.IdFiscalizacao, map => map.MapFrom(m => m.id_fiscalizacao))
                .ForMember(vm => vm.NumeroAutuacao, map => map.MapFrom(m => m.fiscalizacao.numero_autuacao))
                .ForMember(vm => vm.StatusFisc, map => map.MapFrom(m => m.fiscalizacao.status_fiscalizacao.desc_status_fiscalizacao))
                .ForMember(vm => vm.NomeKor, map => map.MapFrom(m => m.kor.nome_kor))
                .ForMember(vm => vm.DescFisc, map => map.MapFrom(m => m.fiscalizacao.desc_fiscalizacao));
            ...
            Mapper.CreateMap<caixa_email, EmailViewModel>()
               ...
               .ForMember(vm => vm.Copia, map => map.MapFrom(m => m.cc))
          ...
          .ForMember(vm => vm.Ativo, map => map.MapFrom(m => m.ativo));
            ...
            Mapper.CreateMap<conta_email, ContaEmailViewModel>()
              .ForMember(vm => vm.IdContaEmail, map => map.MapFrom(m => m.id_conta_email))
              .ForMember(vm => vm.UsuarioId, map => map.MapFrom(m => m.usuario_id))
              .ForMember(vm => vm.SmtpHost, map => map.MapFrom(m => m.smtp_host))
              .ForMember(vm => vm.SmtpPort, map => map.MapFrom(m => m.smtp_port))
              .ForMember(vm => vm.SmtpAuth, map => map.MapFrom(m => m.smtp_auth))
              .ForMember(vm => vm.SmtpUsername, map => map.MapFrom(m => m.smtp_username))
              .ForMember(vm => vm.SmtpPassword, map => map.MapFrom(m => m.smtp_password))
              .ForMember(vm => vm.Pop3Host, map => map.MapFrom(m => m.pop3_host))
              .ForMember(vm => vm.Pop3Port, map => map.MapFrom(m => m.pop3_port))
              .ForMember(vm => vm.Pop3Username, map => map.MapFrom(m => m.pop3_username))
              .ForMember(vm => vm.Pop3Password, map => map.MapFrom(m => m.pop3_password))
              .ForMember(vm => vm.Pop3Delete, map => map.MapFrom(m => m.pop3_delete))
              .ForMember(vm => vm.NomeUsuario, map => map.MapFrom(e => e.usuario.nome));
           ...
           .ForMember(vm => vm.Ativo, map => map.MapFrom(m => m.ativo));
            ...
            Mapper.CreateMap<fiscalizacao, FiscalizacaoViewModel>()
                .ForMember(vm => vm.IdFiscalizacao, map => map.MapFrom(m => m.id_operacao))
                .ForMember(vm => vm.DescFiscalizacao, map => map.MapFrom(m => m.desc_fiscalizacao))
                .ForMember(vm => vm.DataFiscalizacao, map => map.MapFrom(m => m.data_fiscalizacao))
                .ForMember(vm => vm.Posto, map => map.MapFrom(m => m.posto))
                .ForMember(vm => vm.IdStatusFiscalizacao, map => map.MapFrom(m => m.id_status_fiscalizacao))
                .ForMember(vm => vm.IdOperacao, map => map.MapFrom(m => m.id_operacao))
                .ForMember(vm => vm.IdGuia, map => map.MapFrom(m => m.id_guia))
                .ForMember(vm => vm.Ativo, map => map.MapFrom(m => m.ativo))
                .ForMember(vm => vm.IdSubTipoFiscalizacao, map => map.MapFrom(m => m.id_subtipo_fiscalizacao))
                .ForMember(vm => vm.Finalizada, map => map.MapFrom(m => m.finalizada))
                .ForMember(vm => vm.UsuarioId, map => map.MapFrom(m => m.usuario_id))
                .ForMember(vm => vm.DataGravacao, map => map.MapFrom(m => m.data_gravacao))
                .ForMember(vm => vm.NumeroAutuacao, map => map.MapFrom(m => m.numero_autuacao))
                .ForMember(vm => vm.IdKor, map => map.MapFrom(m => m.id_kor))
                .ForMember(vm => vm.Sincronizado, map => map.MapFrom(m => m.sincronizado));
            ...
            Mapper.CreateMap<anexo, AnexoViewModel>()
                ...
                .ForMember(vm => vm.nomeArq, map => map.MapFrom(m => m.desc_anexo))
                .ForMember(vm => vm.data_criado, map => map.MapFrom(m => m.datacriado))
                .ForMember(vm => vm.NomeUsuario, map => map.MapFrom(e => e.usuario.nome));
